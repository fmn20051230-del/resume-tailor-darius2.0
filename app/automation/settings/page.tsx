          ...
          <section className="art-card">
            ...
            <div className="art-form-row">
              ...
              <input
                ...
                placeholder="output"
              />
              <p className="art-hint">Folders saved as <code>01_Company_Position/</code> inside this directory.</p>
            </div>
          </section>
              ...
              {SLOT_DISPLAY.map((slot) => (
                <div key={slot.index} className="art-slot-card">
                  ...
                  <div className="art-slot-file">
                    <span className="art-slot-file-icon">📄</span>
                    <div>
        ...
        <aside className="art-settings-side">
          ...
          <section className="art-card">
            ...
            <ul className="art-info-list">
              <li>Jobs run sequentially — one URL at a time</li>
              <li>Extraction prompt determines resume type (1–4)</li>
              <li>Each folder contains DOCX, PDF, URL, and extracted JD</li>
